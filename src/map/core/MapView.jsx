...
const MapView = ({ children }) => {
  ...
  const activeMapStyles = useAttributePreference('activeMapStyles', 'locationIqStreets,osm,carto,bingHybrid');
  const [defaultMapStyle] = usePersistedState('selectedMapStyle', usePreference('map', 'bingHybrid'));
